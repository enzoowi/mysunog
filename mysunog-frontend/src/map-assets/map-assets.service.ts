...
export class MapAssetsService {
  ...
  // --- Hydrants ---
  findAllHydrants() { return this.hydrantsRepo.find({ order: { name: 'ASC' } }); }
  ...
  // --- Hotspots ---
  findAllHotspots() { return this.hotspotsRepo.find({ order: { barangay: 'ASC' } }); }
  ...
  // --- BFP Stations ---
  findAllStations() { return this.stationsRepo.find({ order: { name: 'ASC' } }); }
